...
if __name__ == "__main__":
    RAW_EN_FILE = "3w_um_src_cleaned.txt"
    RAW_ZH_FILE = "3w_um_zh_cleaned.txt"

    CLEANED_EN_FILE = r"align_cleaned_corpus\cleaned_3w_um_src.txt"
    CLEANED_ZH_FILE = r"align_cleaned_corpus\cleaned_3w_um_zh.txt"
